...
public final class ThreadLocalPool implements ByteBufferPool {
    ...
    public ThreadLocalPool(boolean direct) {
        this.direct = direct;
        this.arrayBackedPool = direct ? new ThreadLocalPool(false) : this;
    }
    ...
    private static final class Pooled implements PooledByteBuffer {
        ...
        private final ThreadLocalPool pool;
        private volatile boolean open = true;

        public Pooled(ThreadLocalPool pool, ByteBuffer buf) {
            this.buf = buf;
            this.pool = pool;
        }
